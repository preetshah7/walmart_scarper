...
browser.get(url)
# this works when you get an error before the button loads
...
dropdown_xpath='/html/body/div[1]/div/div/div/div[1]/div/div[5]/div/div[2]/div/div[2]/div/div[2]/select'

def dropdown_select(xpath):
    element_dropdown_exchange = browser.find_element_by_xpath('')
